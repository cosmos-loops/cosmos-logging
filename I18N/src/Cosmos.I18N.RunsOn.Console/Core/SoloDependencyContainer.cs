    ...
    internal static class SoloDependencyContainer {
        ...
        internal static I18NServiceCollection Initialize(I18NServiceCollection serviceImpl) {
            ...
            serviceImpl.AddDependency(s => {
                ...
                s.AddSingleton(provider => new TranslationProcessor(provider.GetServices<ILanguagePackage>().ToDictionary(package => package.Language.Name)));
        ...
        internal static void AllDone(II18NServiceCollection services) => SetResolver(services.Build());
