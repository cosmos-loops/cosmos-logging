...
namespace Cosmos.Logging.Extensions.Autofac {
    /// <summary>
    /// Autofac Logging Service Provider
    /// </summary>
    [SuppressMessage("ReSharper", "ExplicitCallerInfoArgument")]
    [SuppressMessage("ReSharper", "PrivateFieldCanBeConvertedToLocalVariable")]
    public class AutofacLogServiceProvider: ILoggingServiceProvider {
        ...
        /// <summary>
        /// Create a new instance of <see cref="AutofacLogServiceProvider"/>
        /// </summary>
        /// <param name="provider"></param>
        /// <param name="loggingConfiguration"></param>
        public AutofacLogServiceProvider(IContainer provider, LoggingConfiguration loggingConfiguration) {
            _provider = provider ?? throw new ArgumentNullException(nameof(provider));
            _logPayloadClientProviders = _provider.Resolve<IEnumerable<ILogPayloadClientProvider>>() ?? Enumerable.Empty<ILogPayloadClientProvider>();
        ...
        private ILogger GetLoggerCore(Type sourceType, string categoryName, LogEventLevel? level, Func<string, LogEventLevel, bool> filter,
            ...
            return new AutofacLogger(sourceType ?? typeof(object), minLevel, loggerStateNamespace, filter, mode,
