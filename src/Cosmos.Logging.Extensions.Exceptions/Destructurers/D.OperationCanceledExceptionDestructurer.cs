...
namespace Cosmos.Logging.Extensions.Exceptions.Destructurers
{
    ...
    {
        protected override void DestructureException(OperationCanceledException exception, IExceptionPropertyBag propertyBag, Func<Exception, IReadOnlyDictionary<string, object>> destructureExceptionHandle)
        {
