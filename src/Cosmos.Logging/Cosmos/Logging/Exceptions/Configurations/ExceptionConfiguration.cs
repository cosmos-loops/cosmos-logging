...
namespace Cosmos.Logging.Exceptions.Configurations {
    ...
    public class ExceptionConfiguration : SinkConfiguration {
        ...
        /// <inheritdoc />
        protected internal override void BeforeProcessing(ILoggingSinkOptions settings) {
        ...
        /// <inheritdoc />
        protected internal override void PostProcessing(ILoggingSinkOptions settings) {
            if (settings is ExceptionOptions options) {
