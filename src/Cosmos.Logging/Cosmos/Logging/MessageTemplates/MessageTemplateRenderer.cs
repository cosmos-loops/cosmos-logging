...
namespace Cosmos.Logging.MessageTemplates {
    ...
    internal static class MessageTemplateRenderer {
        public static void Render(MessageTemplate messageTemplate,
            ...
            string format = null, RenderingConfiguration renderingOptions = null,
        ...
        private static StringBuilder RenderEngine(char[] chars, MessageTemplateToken[] tokens,
            ...
            RenderingConfiguration renderingOptions, IFormatProvider formatProvider) {
        ...
        /// <returns></returns>
        private static StringBuilder Som(ILogEventInfo logEventInfo, RenderingConfiguration renderingOptions) {
        ...
        /// <param name="renderingOptions"></param>
        /// <returns></returns>
        private static StringBuilder Eom(StringBuilder stringBuilder, RenderingConfiguration renderingOptions) {
