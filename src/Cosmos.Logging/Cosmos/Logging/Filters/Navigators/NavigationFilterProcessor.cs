...
namespace Cosmos.Logging.Filters.Navigators {
    ...
    internal static class NavigationFilterProcessor {
        ...
        public static LogEventLevel GetDefault() => _defaultLevel.TryGetValue("Global", out var ret) ? ret : LogEventLevelAlias.Maximum;

        public static LogEventLevel GetDefault(string sinkName) => _defaultLevel.TryGetValue(sinkName, out var ret) ? ret : LogEventLevelAlias.Maximum;
    }
}