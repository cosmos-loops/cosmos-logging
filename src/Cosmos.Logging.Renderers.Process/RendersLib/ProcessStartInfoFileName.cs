...
namespace Cosmos.Logging.Renderers.Process.RendersLib {
    [Renderer("StartFileName")]
    public class ProcessStartInfoFileName : BasicPreferencesRenderer {
        ...
        private static string GetStartFileName() {
            return StartFileNameCache ?? (StartFileNameCache = System.Diagnostics.Process.GetCurrentProcess().StartInfo.FileName);
        }
