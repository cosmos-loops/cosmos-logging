...
namespace Cosmos.Logging.Renderers.Process.RendersLib {
    /// <summary>
    /// ProcessBasePriority renderer
    /// </summary>
    [Renderer("ProcessBasePriority")]
    public class ProcessBasePriority : BasicPreferencesRenderer {

        /// <inheritdoc />
        public override string Name => "ProcessBasePriority";

        private static string GetProcessBasePriority() {
            return System.Diagnostics.Process.GetCurrentProcess().BasePriority.ToString();
        }
        ...
        public override string ToString(string format, string paramsText, ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return GetProcessBasePriority();
        }

        /// <inheritdoc />
        public override string ToString(IList<FormatEvent> formattingEvents, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingEvents.ToFormat(GetProcessBasePriority(), formatProvider);
        }

        /// <inheritdoc />
        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(GetProcessBasePriority(), formatProvider);
        }
