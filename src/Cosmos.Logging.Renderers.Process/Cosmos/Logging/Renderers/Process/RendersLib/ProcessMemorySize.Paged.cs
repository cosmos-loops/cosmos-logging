...
namespace Cosmos.Logging.Renderers.Process.RendersLib {
    /// <summary>
    /// PagedMemorySize renderer
    /// </summary>
    [Renderer("PagedMemorySize")]
    public class ProcessPagedMemorySize : BasicPreferencesRenderer {

        /// <inheritdoc />
        public override string Name => "PagedMemorySize";

        private static string GetPagedMemorySize(string format, string paramsText) {
            var cmd = FixedFormat(format, paramsText);
            switch (cmd) {
#pragma warning disable 618
                case 32: return System.Diagnostics.Process.GetCurrentProcess().PagedMemorySize.ToString();
#pragma warning restore 618
                case 64: return System.Diagnostics.Process.GetCurrentProcess().PagedMemorySize64.ToString();
        ...
        public override string ToString(string format, string paramsText, ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return GetPagedMemorySize(format, paramsText);
        }
        ...
        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(GetPagedMemorySize(null, paramsText), formatProvider);
        }
