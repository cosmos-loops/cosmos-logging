...
namespace Cosmos.Logging.Renderers.Process.RendersLib {
    /// <summary>
    /// NonpagedSystemMemorySize renderer
    /// </summary>
    [Renderer("NonpagedSystemMemorySize")]
    public class ProcessNonpagedSystemMemorySize : BasicPreferencesRenderer {

        /// <inheritdoc />
        public override string Name => "NonpagedSystemMemorySize";

        private static string GetNonpagedSystemMemorySize(string format, string paramsText) {
            var cmd = FixedFormat(format, paramsText);
            switch (cmd) {
#pragma warning disable 618
                case 32: return System.Diagnostics.Process.GetCurrentProcess().NonpagedSystemMemorySize.ToString();
#pragma warning restore 618
                case 64: return System.Diagnostics.Process.GetCurrentProcess().NonpagedSystemMemorySize64.ToString();
        ...
        public override string ToString(string format, string paramsText, ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return GetNonpagedSystemMemorySize(format, paramsText);
        }

        /// <inheritdoc />
        public override string ToString(IList<FormatEvent> formattingEvents, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingEvents.ToFormat(GetNonpagedSystemMemorySize(null, paramsText), formatProvider);
        }

        /// <inheritdoc />
        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(GetNonpagedSystemMemorySize(null, paramsText), formatProvider);
        }
