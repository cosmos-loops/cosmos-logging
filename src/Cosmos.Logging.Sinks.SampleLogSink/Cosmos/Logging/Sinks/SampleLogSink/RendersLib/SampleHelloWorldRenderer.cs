...
namespace Cosmos.Logging.Sinks.SampleLogSink.RendersLib {
    /// <summary>
    /// SampleHelloWorldRenderer
    /// </summary>
    [Renderer("HelloWorld", Internals.Constants.SinkKey)]
    // ReSharper disable once InconsistentNaming
    public class SampleHelloWorldRenderer : BasicPreferencesSinkRenderer {

        private const string Content = "Sample, Hello World";
