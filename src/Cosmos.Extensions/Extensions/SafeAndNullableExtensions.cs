...
namespace Cosmos.Extensions
{
    ...
    public static class SafeAndNullableExtensions
    {
        ...
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        public static DateTime SafeDateTime(this object @object, DateTime defaultValue) => @object.SafeDateTime().SafeValue(defaultValue);
        ...
        /// <returns></returns>
        public static IQueryable<T> SafeQueryable<T>(this IQueryable<T> @query) => Judgements.CollectionJudgement.IsNullOrEmpty(query) ? (new List<T>()).AsQueryable() : query;
        ...
        /// <returns></returns>
        public static IQueryable<T> SafeQueryable<T>(this IEnumerable<T> enumerable) => enumerable.AsQueryable().SafeQueryable();
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public static IQueryable SafeQueryable(this IQueryable query) => Judgements.CollectionJudgement.IsNullOrEmpty(query) ? (new List<object>()).AsQueryable() : query;
        ...
        /// <returns></returns>
        public static TypeInfo ToNonNullableTypeInfo(this TypeInfo typeinfo) => Nullable.GetUnderlyingType(typeinfo.AsType()).GetTypeInfo();
        ...
        public static void SafeInvoke(this EventHandler hander, object sender) => hander.SafeInvoke(sender, EventArgs.Empty);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public static void SafeInvoke(this EventHandler hander, object sender, EventArgs e) => hander?.Invoke(sender, e);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public static void SafeInvoke<TEventArgs>(this EventHandler<TEventArgs> hander, object sender, TEventArgs e) => hander?.Invoke(sender, e);
    }
}
