...
namespace Cosmos.Logging {
    /// <summary>
    /// Extensions for TinyIoc and Nancy pipelines
    /// </summary>
    public static class TinyIoCNancyPipelineExtensions {
        /// <summary>
        /// Register Cosmos Logging to pipeline
        /// </summary>
        ...
        private static IEnumerable<ComponentsRegistration> AllComponentsRegistrations =>
            CoreComponentsTypes.Defaults
                               .Concat(CoreComponentsTypes.Appends)
                               .Where(r =>
                                    r.CanUnidirectionalTransfer
