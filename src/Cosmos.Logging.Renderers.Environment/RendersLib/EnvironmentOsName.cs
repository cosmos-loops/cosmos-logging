...
namespace Cosmos.Logging.Renderers.Environment.RendersLib {
    [Renderer("OSName")]
    public class EnvironmentOsName : BasicPreferencesRenderer {

        public override string Name => "OSName";

        private static string GetOsName() {
            var os = System.Environment.OSVersion;
            return $"{os.VersionString} {os.ServicePack}";
        }
        ...
        public override string ToString(IList<FormatEvent> formattingEvents, string paramsText,
            ...
            return formattingEvents.ToFormat(GetOsName(), formatProvider);
        }

        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(GetOsName(), formatProvider);
        }
