...
namespace Cosmos.Logging.Renderers.Environment.RendersLib {
    [Renderer("OSBits")]
    public class EnvironmentOsBits : BasicPreferencesRenderer {

        public override string Name => "OSBits";

        private static string GetOsBits() {
            var b64 = System.Environment.Is64BitOperatingSystem;
            return b64 ? "x64" : "x86";
        }
        ...
        public override string ToString(IList<FormatEvent> formattingEvents, string paramsText,
            ...
            return formattingEvents.ToFormat(GetOsBits(), formatProvider);
        }

        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(GetOsBits(), formatProvider);
        }
