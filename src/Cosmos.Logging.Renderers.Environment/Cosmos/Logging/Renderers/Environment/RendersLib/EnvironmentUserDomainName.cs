...
namespace Cosmos.Logging.Renderers.Environment.RendersLib {
    /// <summary>
    /// UserDomainName renderer
    /// </summary>
    [Renderer("UserDomainName")]
    public class EnvironmentUserDomainName : BasicPreferencesRenderer {

        /// <inheritdoc />
        public override string Name => "UserDomainName";
        ...
        public override string ToString(IList<FormatEvent> formattingEvents, string paramsText,
            ...
            return formattingEvents.ToFormat(System.Environment.UserDomainName, formatProvider);
        }

        /// <inheritdoc />
        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(System.Environment.UserDomainName, formatProvider);
        }
