...
namespace Cosmos.Logging.Sinks.JdCloud.RendersLib {
    /// <summary>
    /// JdCloud hello world renderer
    /// </summary>
    [Renderer("HelloWorld", Constants.SinkKey)]
    // ReSharper disable once InconsistentNaming
    public class JdCloudHelloWorldRenderer : BasicPreferencesSinkRenderer {
        private const string Content = "JD Cloud Log Service, Hello World";
