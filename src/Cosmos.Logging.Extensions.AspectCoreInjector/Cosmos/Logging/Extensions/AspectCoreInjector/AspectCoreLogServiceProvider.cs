...
namespace Cosmos.Logging.Extensions.AspectCoreInjector {
    /// <summary>
    /// AspectCore Logging Service Provider
    /// </summary>
    [SuppressMessage("ReSharper", "ExplicitCallerInfoArgument")]
    [SuppressMessage("ReSharper", "PrivateFieldCanBeConvertedToLocalVariable")]
    public class AspectCoreLogServiceProvider: ILoggingServiceProvider {
        private readonly IServiceResolver _provider;
        ...
        private ILogger GetLoggerCore(Type sourceType, string categoryName, LogEventLevel? level, Func<string, LogEventLevel, bool> filter,
            ...
            return new AspectCoreLogger(sourceType ?? typeof(object), minLevel, loggerStateNamespace, filter, mode,
