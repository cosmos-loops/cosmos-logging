...
namespace Cosmos.Logging.Extensions.AspectCoreInjector {
    ...
    public class AspectCoreLogger : LoggerBase, IFutureableLogger<AspectCoreFutureLogger> {
        ...
        public override IFutureLogger ToFuture(
            ...
            return new AspectCoreFutureLogger(this, memberName, filePath, lineNumber);
        }

        /// <inheritdoc />
        public override ISimpleLogger ToSimple() {
            return new AspectCoreSimpleLogger(TargetType, MinimumLevel, StateNamespace, ExposeFilter(), ExposeLogPayloadSender());
        }

#pragma warning disable 1066,4024,4025,4026
        AspectCoreFutureLogger IFutureableLogger<AspectCoreFutureLogger>.ToFuture(
            [CallerMemberName] string memberName = null,
            [CallerFilePath] string filePath = null,
            [CallerLineNumber] int lineNumber = 0) {
