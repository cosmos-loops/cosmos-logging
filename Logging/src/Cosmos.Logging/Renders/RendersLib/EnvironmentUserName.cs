...
namespace Cosmos.Logging.Renders.RendersLib {
    public class EnvironmentUserName : BasicPreferencesRenderer {
        ...
        public override string ToString(IList<FormatEvent> formattingEvents, string paramsText,
            ...
            return formattingEvents.ToFormat(Environment.UserName, formatProvider);
        }

        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(Environment.UserName, formatProvider);
        }
