...
namespace Cosmos.Logging.Sinks.NLog.RendersLib {
    // ReSharper disable once InconsistentNaming
    [Renderer("HelloWorld", Internals.Constants.SinkKey)]
    public class NLogHelloWorldRenderer : BasicPreferencesSinkRenderer {

        private const string Content = "NLog, Hello World";
