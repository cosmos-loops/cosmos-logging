...
namespace Cosmos.Logging.Renderers.Process.RendersLib {
    [Renderer("WorkingSet")]
    public class ProcessWorkingSet : BasicPreferencesRenderer {

        public override string Name => "WorkingSet";

        private static string GetWorkingSet(string format, string paramsText) {
            var cmd = FixedFormat(format, paramsText);
            switch (cmd) {
#pragma warning disable 618
                case 32: return System.Diagnostics.Process.GetCurrentProcess().WorkingSet.ToString();
#pragma warning restore 618
                case 64: return System.Diagnostics.Process.GetCurrentProcess().WorkingSet64.ToString();
        ...
        public override string ToString(string format, string paramsText, ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return GetWorkingSet(format, paramsText);
        }

        public override string ToString(IList<FormatEvent> formattingEvents, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingEvents.ToFormat(GetWorkingSet(null, paramsText), formatProvider);
        }

        public override string ToString(IList<Func<object, IFormatProvider, object>> formattingFuncs, string paramsText,
            ILogEventInfo logEventInfo = null, IFormatProvider formatProvider = null) {
            return formattingFuncs.ToFormat(GetWorkingSet(null, paramsText), formatProvider);
        }
