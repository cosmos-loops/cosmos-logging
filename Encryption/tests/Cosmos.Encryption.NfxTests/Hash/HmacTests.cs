...
namespace Cosmos.Encryption.Tests.Hash {
    public class HmacTests {
        ...
        public void HmacSha512Test() {
            var signature = HMACSHA512HashingProvider.Encrypt("image", "alexinea");
