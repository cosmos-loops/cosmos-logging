...
namespace Cosmos.Encryption.Tests.Hash {
    public class ShaTests {
        ...
        public void Sha512Test() {
            var signature = SHA512HashingProvider.Encrypt("image");
